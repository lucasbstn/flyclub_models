...
Map<String, dynamic> _$$_ForecastToJson(_$_Forecast instance) =>
    <String, dynamic>{
      ...
      'icing': instance.icing.map((e) => e.toJson()).toList(),
      'turbulence': instance.turbulence.map((e) => e.toJson()).toList(),
      'probability': instance.probability?.toJson(),
      'raw': instance.raw,
      'sanitized': instance.sanitized,
      'transition_start': instance.transitionStart?.toJson(),
      'type': instance.type,
